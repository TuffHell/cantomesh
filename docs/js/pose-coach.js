...
export const POSES = [
  {
    ...
    hold: 0,
    variants: [[
      { kind: "angle", joints: [LM.L_SHO, LM.L_ELB, LM.L_WRI], target: 110, tol: 50, hint: "左肘彎成弧形" },
      { kind: "angle", joints: [LM.R_SHO, LM.R_ELB, LM.R_WRI], target: 110, tol: 50, hint: "右肘彎成弧形" },
      { kind: "level", a: LM.L_WRI, b: LM.L_SHO, tol: 0.14, hint: "左掌抬至與肩同高" },
      { kind: "level", a: LM.R_WRI, b: LM.R_SHO, tol: 0.14, hint: "右掌抬至與肩同高" },
    ]],
  },
  {
    ...
    variants: [
      [ // right arm up, left arm extended
        { kind: "raise", point: LM.R_WRI, ref: LM.NOSE, good: 0.06, hint: "右臂高舉過頭頂" },
        { kind: "angle", joints: [LM.R_SHO, LM.R_ELB, LM.R_WRI], target: 165, tol: 45, hint: "舉起的手臂伸直" },
        { kind: "level", a: LM.L_WRI, b: LM.L_SHO, tol: 0.16, hint: "左臂平展與肩同高" },
      ],
      [ // left arm up, right arm extended
        { kind: "raise", point: LM.L_WRI, ref: LM.NOSE, good: 0.06, hint: "左臂高舉過頭頂" },
        { kind: "angle", joints: [LM.L_SHO, LM.L_ELB, LM.L_WRI], target: 165, tol: 45, hint: "舉起的手臂伸直" },
        { kind: "level", a: LM.R_WRI, b: LM.R_SHO, tol: 0.16, hint: "右臂平展與肩同高" },
      ],
    ],
  },
  {
    ...
    variants: [
      [
        { kind: "raise", point: LM.R_WRI, ref: LM.NOSE, good: 0.08, hint: "右手高指過頂" },
        { kind: "angle", joints: [LM.R_SHO, LM.R_ELB, LM.R_WRI], target: 170, tol: 35, hint: "高舉之臂挺直" },
        { kind: "level", a: LM.L_WRI, b: LM.L_SHO, tol: 0.16, hint: "左臂橫展齊肩" },
        { kind: "angle", joints: [LM.L_SHO, LM.L_ELB, LM.L_WRI], target: 165, tol: 45, hint: "橫展之臂伸直" },
      ],
      [
        { kind: "raise", point: LM.L_WRI, ref: LM.NOSE, good: 0.08, hint: "左手高指過頂" },
        { kind: "angle", joints: [LM.L_SHO, LM.L_ELB, LM.L_WRI], target: 170, tol: 35, hint: "高舉之臂挺直" },
        { kind: "level", a: LM.R_WRI, b: LM.R_SHO, tol: 0.16, hint: "右臂橫展齊肩" },
        { kind: "angle", joints: [LM.R_SHO, LM.R_ELB, LM.R_WRI], target: 165, tol: 45, hint: "橫展之臂伸直" },
      ],
    ],
  },
];
